...
sed -i 's/mtpc-template-repo/my-project/g' $(grep -rl 'mtpc-template-repo' .)
...
| Placeholder | Description | Example | Files |
|---|---|---|---|
| `mtpc-template-repo` | Human-readable project name | `My Project` | SECURITY.md, CODE_OF_CONDUCT.md, TOPOLOGY.md, STATE.a2ml, Justfile, GOVERNANCE.md, MAINTAINERS.md, flake.nix, devcontainer.json |
...
| `mtpc-template-repo` | Repository name (slug) | `my-project` | CONTRIBUTING.md, SECURITY.md, CODE_OF_CONDUCT.md, cliff.toml |
