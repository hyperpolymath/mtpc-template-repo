...
// Replace mtpc-template-repo, Mtpc Template Repo — See README.adoc for details., just run, Mtpc Template Repo started successfully. with actuals
= mtpc-template-repo — Quick Start for Users
:toc:
:toclevels: 2

== What is mtpc-template-repo?

Mtpc Template Repo — See README.adoc for details.
...
[source,bash]
----
just install --portable --prefix=./mtpc-template-repo-portable
----
...
[source]
----
Mtpc Template Repo started successfully.
----
...
* **Wiki**: https://github.com/hyperpolymath/mtpc-template-repo/wiki
