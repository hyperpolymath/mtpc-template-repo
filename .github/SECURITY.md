...
1. Navigate to [Report a Vulnerability](https://github.com/hyperpolymath/mtpc-template-repo/security/advisories/new)
...
- This repository (`hyperpolymath/mtpc-template-repo`) and all its code
...
- **GitHub Security Advisories**: Published at [Security Advisories](https://github.com/hyperpolymath/mtpc-template-repo/security/advisories)
...
When using mtpc-template-repo, we recommend:
...
- [Security Advisories](https://github.com/hyperpolymath/mtpc-template-repo/security/advisories)
...
| Purpose | Contact |
|---------|---------|
| **Security issues** | [Report via GitHub](https://github.com/hyperpolymath/mtpc-template-repo/security/advisories/new) or {{SECURITY_EMAIL}} |
| **General questions** | [GitHub Discussions](https://github.com/hyperpolymath/mtpc-template-repo/discussions) |
...
*Thank you for helping keep mtpc-template-repo and its users safe.* 🛡️
