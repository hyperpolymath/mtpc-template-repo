...
project := "mtpc-template-repo"
OWNER := "hyperpolymath"
REPO := "mtpc-template-repo"
version := "0.1.0"
...
doctor:
    @echo "Running diagnostics for mtpc-template-repo..."
...
heal:
    @echo "Attempting auto-repair for mtpc-template-repo..."
...
help-me:
    @echo "=== mtpc-template-repo Help ==="
    @echo "Platform: $(uname -s) $(uname -m)"
    @echo "Shell: $SHELL"
    @echo ""
    @echo "To report an issue:"
    @echo "  https://github.com/hyperpolymath/mtpc-template-repo/issues/new"
    @echo ""
