...
// Replace mtpc-template-repo, {{PACKAGE_NAME}}, {{DEPS}} with actuals
= mtpc-template-repo — Quick Start for Platform Maintainers
:toc:
:toclevels: 2

== Overview

This guide covers packaging, deploying, and maintaining mtpc-template-repo for
...
podman build -t mtpc-template-repo .
----
...
* Upstream: https://github.com/hyperpolymath/mtpc-template-repo/issues
